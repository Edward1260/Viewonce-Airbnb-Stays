...
(function() {
  ...
  const SUPABASE_URL = typeof process !== 'undefined' ? process.env.NEXT_PUBLIC_SUPABASE_URL : window.config?.SUPABASE_URL;
  const SUPABASE_ANON_KEY = typeof process !== 'undefined' ? process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY : window.config?.SUPABASE_ANON_KEY;
